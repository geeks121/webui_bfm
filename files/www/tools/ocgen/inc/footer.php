...
<button class="btn btn-primary floating-button" onclick="toggleTheme()" type="button">
<span class="sr-only">Change Theme</span>
 <svg width="80" height="80" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="astro-KXYEDVG6">
...
<footer align="center" class="text-info" style="font-family:helvetica">
<strong>
	Version <?php echo $versi; ?>
	</p><p align="center" class="text-info">
	&copy;<?php echo date('Y'); ?> <?php echo $ocgen; ?><br><br>
	</p>
	<p align="center" class="text-info"><i class="fa fa-github" aria-hidden="true"></i> Github: <a href="<?php echo $github; ?>" target="blank"><?php echo $ocgen; ?></a>
</strong>
</footer>
                </div>
            </div>    
